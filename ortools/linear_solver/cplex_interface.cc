...
CplexInterface::CplexInterface(MPSolver *const solver, bool mip)
  ...
  try {
    ...
    lib_->GetFunction(&CPXXaddcols, "CPXLaddcols");
    lib_->GetFunction(&CPXXaddrows, "CPXLaddrows");
    lib_->GetFunction(&CPXXchgbds, "CPXLchgbds");
    lib_->GetFunction(&CPXXchgcoef, "CPXLchgcoef");
    lib_->GetFunction(&CPXXchgcoeflist, "CPXLchgcoeflist");
    lib_->GetFunction(&CPXXchgctype, "CPXLchgctype");
    lib_->GetFunction(&CPXXchgobj, "CPXLchgobj");
    lib_->GetFunction(&CPXXchgobjsen, "CPXLchgobjsen");
    lib_->GetFunction(&CPXXchgprobtype, "CPXLchgprobtype");
    lib_->GetFunction(&CPXXchgrhs, "CPXLchgrhs");
    lib_->GetFunction(&CPXXchgrngval, "CPXLchgrngval");
    lib_->GetFunction(&CPXXchgsense, "CPXLchgsense");
    lib_->GetFunction(&CPXXcloseCPLEX, "CPXLcloseCPLEX");
    lib_->GetFunction(&CPXXcreateprob, "CPXLcreateprob");
    lib_->GetFunction(&CPXXdelcols, "CPXLdelcols");
    lib_->GetFunction(&CPXXdelrows, "CPXLdelrows");
    lib_->GetFunction(&CPXXfreeprob, "CPXLfreeprob");
    lib_->GetFunction(&CPXXgetbase, "CPXLgetbase");
    lib_->GetFunction(&CPXXgetbestobjval, "CPXLgetbestobjval");
    lib_->GetFunction(&CPXXgetdblquality, "CPXLgetdblquality");
    lib_->GetFunction(&CPXXgetdj, "CPXLgetdj");
    lib_->GetFunction(&CPXXgetitcnt, "CPXLgetitcnt");
    lib_->GetFunction(&CPXXgetmipitcnt, "CPXLgetmipitcnt");
    lib_->GetFunction(&CPXXgetnodecnt, "CPXLgetnodecnt");
    lib_->GetFunction(&CPXXgetnumcols, "CPXLgetnumcols");
    lib_->GetFunction(&CPXXgetnumrows, "CPXLgetnumrows");
    lib_->GetFunction(&CPXXgetobjval, "CPXLgetobjval");
    lib_->GetFunction(&CPXXgetpi, "CPXLgetpi");
    lib_->GetFunction(&CPXXgetstat, "CPXLgetstat");
    lib_->GetFunction(&CPXXgetx, "CPXLgetx");
    lib_->GetFunction(&CPXXlpopt, "CPXLlpopt");
    lib_->GetFunction(&CPXXmipopt, "CPXLmipopt");
    lib_->GetFunction(&CPXXnewcols, "CPXLnewcols");
    lib_->GetFunction(&CPXXnewrows, "CPXLnewrows");
    lib_->GetFunction(&CPXXopenCPLEX, "CPXLopenCPLEX");
    ...
    lib_->GetFunction(&CPXEsetobjoffset, "CPXLEsetobjoffset");
